...
find src/ -type f \( -name "*.o" -o -name "*.out" -o -name "*.exe" -o -name "*output.txt" \) # works in any linux distro
find src/ -type f \( -name "*.o" -o -name "*.out" -o -name "*.exe" -o -name "*output.txt" \) -delete
